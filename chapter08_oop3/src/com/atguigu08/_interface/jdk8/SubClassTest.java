 ...
 *
 * @Author yao
 * @Create 2024/9/3 10:43
 * @Version 1.0
 */
public class SubClassTest {
    public static void main(String[] args) {
        // 知识点1：接口中声明的静态方法只能被接口调用，不能使用其他实现类进行调用。
        CompareA.method1();
        //SubClass.method1();
        System.out.println();

        // 知识点2：接口中声明的默认方法可以被实现类继承，
        // 实现类在没有重写此方法的情况下，默认调用接口中声明的默认方法
        // 如果实现类重写了此方法，则调用的是自己重写后的方法。
        ...
        // 默认情况下，子类在没有重写此方法的情况下，调用的是父类中的方法。 --> 类优先原则
        s1.method4();
        System.out.println();
